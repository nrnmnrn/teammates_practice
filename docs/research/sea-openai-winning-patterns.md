...
- 決賽在 **2026 年 9 月 12 日（六）09:30–21:30** 於 **TICC 台北國際會議中心 4 樓鳳凰廳** 舉行；參賽者須自行攜帶筆電與開發工具。[Sea × OpenAI Codex Hackathon Taiwan 官方頁面](https://shopee.tw/m/seaxopenai-hackathon-tw)
- 入選團隊須在活動當天使用 **OpenAI Codex** 開發，並在期限內完成產品與成果展示；活動目標是把創意快速做成具實際應用價值的 AI 解決方案。
- 台灣站為 Sea 與 OpenAI 共同主辦的亞太系列賽；官方頁面說明其面向熟悉 AI 程式開發、能打造可實際應用產品的開發者。
...
本文件的台灣站資訊來自 [Sea × OpenAI Codex Hackathon Taiwan 官方頁面](https://shopee.tw/m/seaxopenai-hackathon-tw)；新加坡站的題目、評分與得獎案例是有根據的前例，但台灣站可能在現場提供不同的題目、工具、提交格式或評審標準。決賽前後若收到官方 email、現場簡報或官方網站更新，應以最新的主辦資訊覆蓋本文件。
